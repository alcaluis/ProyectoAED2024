...
Es importante mencionar que hay ciertos delitos que no son significativos para su análisis debido a su escaso número de registros, lo que les resta importancia, como sucede con las falsedades y la mayoría de las faltas.
...
# Analisis bivariante clasificaciones
# Quitamos las faltas, falsedades y resto de delitos

delitos_clasi_2 <- delitos_clasi %>%
  filter(!grepl('Faltas',clasi_infrac)) %>% # Quitamos faltas
...
# Delitos vs edades (usando las subclasificaciones) (quitar faltas)
